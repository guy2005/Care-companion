...
-- 2. ปลด Foreign Key ของ profiles.id ไปยัง auth.users ชั่วคราวเพื่อให้เพิ่ม Seed Data ได้
ALTER TABLE public.profiles DROP CONSTRAINT IF EXISTS profiles_id_fkey;

-- 3. เปิดสิทธิ์ RLS ให้ครอบคลุมสำหรับการทดสอบระบบ
...
-- 4. เพิ่มข้อมูลผู้ใช้งานและผู้ร่วมเดินทาง (Profiles)
...
-- 5. เพิ่มข้อมูลประวัติและความสามารถของผู้ร่วมเดินทาง (companion_profiles)
...
-- 6. เพิ่มตัวอย่าง Bookings ที่สำเร็จแล้วเพื่อให้ผูกกับ Reviews
